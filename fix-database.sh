...
CREATE INDEX IF NOT EXISTS idx_materials_category ON warehouse_materials(category);
CREATE INDEX IF NOT EXISTS idx_movements_material ON material_movements(material_id);
CREATE INDEX IF NOT EXISTS idx_movements_project ON material_movements(project_id);
