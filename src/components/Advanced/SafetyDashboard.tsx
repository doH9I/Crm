...
const SafetyDashboard: React.FC<SafetyDashboardProps> = ({ projectId }) => {
  ...
  const mockIncidents: SafetyIncident[] = [
    {
      ...
      location: 'Стройплощадка №1, участок А',
      type: 'near_miss',
      severity: 'medium',
      description: 'Падение строительного материала с высоты, никто не пострадал',
      peopleInvolved: ['user-2'],
      immediateAction: 'Место оградили, материалы закреплены',
      status: 'resolved',
      createdAt: new Date(),
      updatedAt: new Date(),
    },
  ...
  const mockTrainings: Training[] = [
    {
      id: '1',
      name: 'Техника безопасности при высотных работах',
      type: 'safety',
      description: 'Обучение правилам безопасности при работе на высоте',
      duration: 4,
      ...
      participants: [
        ...
        { userId: 'user-2', status: 'enrolled' },
        { userId: 'user-3', status: 'enrolled' },
      ],
      cost: 15000,
      isRequired: true,
      certificate: true,
